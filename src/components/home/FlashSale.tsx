            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative flex items-center gap-1.5">
                ...
                <div className="flex items-center gap-1.5 bg-white/80 dark:bg-card/80 backdrop-blur-sm rounded-xl px-2.5 py-1.5 border border-red-200/50 dark:border-red-800/30 shadow-sm inner-shadow-accent relative overflow-hidden r27-timer-glow r39-countdown-badge r58-flash-countdown-pulse">
                  ...
                  <div className="r42-digit-spring r44-countdown-ring-shadow"><CountdownRing value={hours} max={24} size={34} strokeWidth={2.5} gradientId="flash-h" /></div>
                  <div className="r42-digit-spring r44-countdown-ring-shadow"><CountdownRing value={minutes} max={60} size={34} strokeWidth={2.5} gradientId="flash-m" /></div>
                  <div className="r42-digit-spring r44-countdown-ring-shadow"><CountdownRing value={seconds} max={60} size={34} strokeWidth={2.5} gradientId="flash-s" /></div>
